...
async function createproduct(req,res){
    ...
    let {businessname,location,phonenumber,email,title,description} = req.body;
    const imageUrl = req.file.path;
    try{
        let user = new product({businessname,location,phonenumber,email,title,description,image:imageUrl});
        await user.save();
